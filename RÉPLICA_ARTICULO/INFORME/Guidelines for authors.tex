...
Otro aspecto importante que se compara en este libro, es el tamaño de muestra necesario para dos niveles de AQL establecidos, en la tabla 1 se observa la comparación que obtuvimos, y además, le añadimos los riesgos del productor que se podrían dar con cada uno de los planes de muestreo.
